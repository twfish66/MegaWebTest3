...
'外部系統介接電文日誌查詢'
WebUI.click(findTestObject('Bank_manage/Daily_Recoder/Outside_Daily_Query/outside_daily_query_menu'))
...
WebUI.selectOptionByLabel(findTestObject('Bank_manage/Daily_Recoder/Outside_Daily_Query/select_QRPEbill'), '電子發票電文', false)

WebUI.selectOptionByLabel(findTestObject('Bank_manage/Daily_Recoder/Outside_Daily_Query/select_query_reason'), '01-客戶書面申請查詢', 
    false)

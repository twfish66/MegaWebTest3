...
'中台服務電文日誌查詢'
WebUI.click(findTestObject('Bank_manage/Daily_Recoder/Service_Daily_Query/service_menu'))
...
WebUI.selectOptionByLabel(findTestObject('Bank_manage/Daily_Recoder/Service_Daily_Query/select_POS'), '收單', false)

WebUI.selectOptionByLabel(findTestObject('Bank_manage/Daily_Recoder/Service_Daily_Query/select_ GET'), 'GET', false)

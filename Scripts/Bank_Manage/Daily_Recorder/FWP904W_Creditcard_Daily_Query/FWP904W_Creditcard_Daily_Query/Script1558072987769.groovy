...
'信用卡電文日誌查詢'
WebUI.click(findTestObject('Bank_manage/Daily_Recoder/Creditcard_Daily_Query/creditcard_menu'))
...
WebUI.selectOptionByLabel(findTestObject('Bank_manage/Daily_Recoder/Creditcard_Daily_Query/select_type'), '發卡端呼叫', false)

WebUI.selectOptionByLabel(findTestObject('Bank_manage/Daily_Recoder/Creditcard_Daily_Query/select_GETPOST'), 'POST', false)

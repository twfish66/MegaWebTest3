...
'內部系統介接電文日誌查詢'
WebUI.click(findTestObject('Bank_manage/Daily_Recoder/Internal_Interface_Query/internal_interface_query_menu'))
...
WebUI.selectOptionByLabel(findTestObject('Bank_manage/Daily_Recoder/Internal_Interface_Query/select_type'), '接收', false)

WebUI.selectOptionByLabel(findTestObject('Bank_manage/Daily_Recoder/Internal_Interface_Query/select_ GETPOST'), 'GET', false)

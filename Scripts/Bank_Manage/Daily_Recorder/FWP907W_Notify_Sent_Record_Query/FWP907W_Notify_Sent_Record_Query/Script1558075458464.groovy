...
'推播發送記錄檔'
WebUI.click(findTestObject('Bank_manage/Daily_Recoder/Notify_Sent_Record_Query/notify_sent_record_menu'))
...
WebUI.selectOptionByLabel(findTestObject('Bank_manage/Daily_Recoder/Notify_Sent_Record_Query/select_ type'), '收單端', false)

WebUI.selectOptionByLabel(findTestObject('Bank_manage/Daily_Recoder/Notify_Sent_Record_Query/select_status'), '成功', false)
...
WebUI.click(findTestObject('Bank_manage/Daily_Recoder/Notify_Sent_Record_Query/resent_button'))
